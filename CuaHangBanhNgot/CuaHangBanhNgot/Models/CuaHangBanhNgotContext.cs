...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-5N607HA4\\MAY1;Database=CuaHangBanhNgot;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ChiTietHoaDon>(entity =>
        {
            entity.HasKey(e => new { e.MaHd, e.MaSp }).HasName("PK__ChiTietH__F557F661258F475F");
        ...
        {
            entity.HasKey(e => e.MaHd).HasName("PK__HoaDon__2725A6E0134AF335");
        ...
        {
            entity.HasKey(e => e.MaKh).HasName("PK__KhachHan__2725CF1EA0551C03");
        ...
        {
            entity.HasKey(e => e.MaNcc).HasName("PK__NhaCungC__3A185DEB327D7E12");
        ...
        {
            entity.HasKey(e => e.MaNv).HasName("PK__NhanVien__2725D70AA6393FB8");
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__2725081C2FA7DD4A");
